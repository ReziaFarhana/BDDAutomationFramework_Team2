...
// Action Method class
    ...
    @FindBy(how = How.XPATH, using = helloSignInLocator)
    public WebElement helloSignIn;
    @FindBy(how = How.XPATH, using = emailPhoneForSignInLocator)
    public WebElement emailPhoneForSignIn;
    @FindBy(how = How.XPATH, using = passwordForSignInLocator)
    public WebElement passwordForSignIn;
    @FindBy(how = How.XPATH, using = continueForSignInLocator)
    public WebElement continueForSignIn;
    @FindBy(how = How.XPATH, using = signInSubmitLocator)
    public WebElement signInSubmit;
    @FindBy(how = How.XPATH, using = helloUserLocator)
    public WebElement helloUser;
    @FindBy(how = How.XPATH, using = errorMessageLocator)
    public WebElement errorMessage;
    @FindBy(how = How.XPATH, using = customerNameLocator)
    public WebElement customerName;
    @FindBy(how = How.XPATH, using = createYourAmazonAccountLocator)
