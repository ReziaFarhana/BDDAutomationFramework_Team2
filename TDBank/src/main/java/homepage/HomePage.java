...
public class HomePage extends WebAPI {
    ...
    //  Action Method class
    @FindBy(how = How.CSS, using = textStudentLocator) public WebElement text;

    public void clickOnServices() {
        clickByCss(servicesLocator);

    }

    public void hoverOnStudentBanking() {
        mouseHoverByXpath(studentBankingLocator);

    }
   public void ShouldSeeSmartAndSimpleStudentBanking(){

   }

    //  @FindBy(how = How.XPATH, using = text1Locator)public WebElement text1;

  public void verifyText() {
      String expectedText = "Smart and simple student banking";
